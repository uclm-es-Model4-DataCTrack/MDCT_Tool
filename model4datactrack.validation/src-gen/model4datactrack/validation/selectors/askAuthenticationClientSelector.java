 ...
 * @generated
 */
public class askAuthenticationClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "askAuthentication"); //$NON-NLS-1$
	}
}

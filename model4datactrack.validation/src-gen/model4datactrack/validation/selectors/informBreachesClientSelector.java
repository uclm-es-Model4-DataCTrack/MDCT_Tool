 ...
 * @generated
 */
public class informBreachesClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "informBreaches"); //$NON-NLS-1$
	}
}

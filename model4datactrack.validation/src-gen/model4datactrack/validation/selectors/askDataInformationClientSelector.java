 ...
 * @generated
 */
public class askDataInformationClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "askDataInformation"); //$NON-NLS-1$
	}
}

 ...
 * @generated
 */
public class StatelessComputationMachineClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "StatelessComputationMachine"); //$NON-NLS-1$
	}
}

 ...
 * @generated
 */
public class ControllerCPClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "ControllerCP"); //$NON-NLS-1$
	}
}

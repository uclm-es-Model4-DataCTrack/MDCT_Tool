 ...
 * @generated
 */
public class removeDataClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "removeData"); //$NON-NLS-1$
	}
}

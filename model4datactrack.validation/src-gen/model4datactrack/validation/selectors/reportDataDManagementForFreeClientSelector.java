...
package model4datactrack.validation.selectors;
 ...
 * @generated
 */
public class reportDataDManagementForFreeClientSelector implements IClientSelector {

	public boolean selects(Object stereoApplicationObj) {
		return StereotypeUtil.checkStereoApplication(stereoApplicationObj, "reportDataDManagementForFree"); //$NON-NLS-1$
	}
}

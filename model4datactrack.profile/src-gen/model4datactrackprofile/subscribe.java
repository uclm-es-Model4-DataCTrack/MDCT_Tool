...
public interface subscribe extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Breaches</b></em>' containment reference list.
	 * The list contents are of type {@link model4datactrackprofile.breachInfo}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Breaches</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Breaches</em>' containment reference list.
	 * @see model4datactrackprofile.Model4datactrackprofilePackage#getsubscribe_Breaches()
	 * @model containment="true" required="true" ordered="false"
	 * @generated
	 */
	EList<breachInfo> getBreaches();

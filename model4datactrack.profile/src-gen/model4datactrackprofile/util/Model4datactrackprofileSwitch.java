 ...
 * @generated
 */
public class Model4datactrackprofileSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public Model4datactrackprofileSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Model4datactrackprofilePackage.BREACH_INFO: {
				breachInfo breachInfo = (breachInfo)theEObject;
				T result = casebreachInfo(breachInfo);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>breach Info</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>breach Info</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casebreachInfo(breachInfo object) {
		return null;
	}

 ...
 * </p>
 * <ul>
 *   <li>{@link model4datactrackprofile.impl.subscribeImpl#getBase_Message <em>Base Message</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.subscribeImpl#getData <em>Data</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.subscribeImpl#getMachines <em>Machines</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.subscribeImpl#getBreaches <em>Breaches</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.subscribeImpl#getMaxSubscriptionTime <em>Max Subscription Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class subscribeImpl extends MinimalEObjectImpl.Container implements subscribe {
	...
	/**
	 * The cached value of the '{@link #getBreaches() <em>Breaches</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getBreaches()
	 * @generated
	 * @ordered
	 */
	protected EList<breachInfo> breaches;
	...
	protected EClass eStaticClass() {
		return Model4datactrackprofilePackage.Literals.SUBSCRIBE;
	}
		...
		if (base_Message != null && base_Message.eIsProxy()) {
			...
			if (base_Message != oldBase_Message) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4datactrackprofilePackage.SUBSCRIBE__BASE_MESSAGE, oldBase_Message, base_Message));
			}
		}
		return base_Message;
	}
	...
	public void setBase_Message(Message newBase_Message) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.SUBSCRIBE__BASE_MESSAGE, oldBase_Message, base_Message));
	}
	...
	public Data getData() {
		if (data != null && data.eIsProxy()) {
			...
			if (data != oldData) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4datactrackprofilePackage.SUBSCRIBE__DATA, oldData, data));
			}
		}
		return data;
	}
	...
	public void setData(Data newData) {
		...
		data = newData;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.SUBSCRIBE__DATA, oldData, data));
	}
	...
	public SSMProcessor getMachines() {
		if (machines != null && machines.eIsProxy()) {
			...
			if (machines != oldMachines) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4datactrackprofilePackage.SUBSCRIBE__MACHINES, oldMachines, machines));
			}
		}
		return machines;
	}
	...
	public void setMachines(SSMProcessor newMachines) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.SUBSCRIBE__MACHINES, oldMachines, machines));
	}
	 ...
	 * @generated
	 */
	public EList<breachInfo> getBreaches() {
		if (breaches == null) {
			breaches = new EObjectContainmentEList<breachInfo>(breachInfo.class, this, Model4datactrackprofilePackage.SUBSCRIBE__BREACHES);
		}
		return breaches;
	}
	...
	public NotificationChain basicSetMaxSubscriptionTime(Time newMaxSubscriptionTime, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.SUBSCRIBE__MAX_SUBSCRIPTION_TIME, oldMaxSubscriptionTime, newMaxSubscriptionTime);
	...
	public void setMaxSubscriptionTime(Time newMaxSubscriptionTime) {
		if (newMaxSubscriptionTime != maxSubscriptionTime) {
			...
			if (maxSubscriptionTime != null)
				msgs = ((InternalEObject)maxSubscriptionTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Model4datactrackprofilePackage.SUBSCRIBE__MAX_SUBSCRIPTION_TIME, null, msgs);
			if (newMaxSubscriptionTime != null)
				msgs = ((InternalEObject)newMaxSubscriptionTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Model4datactrackprofilePackage.SUBSCRIBE__MAX_SUBSCRIPTION_TIME, null, msgs);
			msgs = basicSetMaxSubscriptionTime(newMaxSubscriptionTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.SUBSCRIBE__MAX_SUBSCRIPTION_TIME, newMaxSubscriptionTime, newMaxSubscriptionTime));
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Model4datactrackprofileValidator.SUBSCRIBE__MAX_SUB_TIME_GREATER_THAN_0,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Model4datactrackprofileValidator.DIAGNOSTIC_SOURCE,
						 Model4datactrackprofileValidator.SUBSCRIBE__MACHINE_CONTAINS_DATA_TO_SUBSCRIBE_TO,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Model4datactrackprofileValidator.DIAGNOSTIC_SOURCE,
						 Model4datactrackprofileValidator.SUBSCRIBE__SUBSCRIBE_DESTINATION_MACHINES_COMPLY_WITH_GDPR,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Model4datactrackprofilePackage.SUBSCRIBE__BREACHES:
				return ((InternalEList<?>)getBreaches()).basicRemove(otherEnd, msgs);
			case Model4datactrackprofilePackage.SUBSCRIBE__MAX_SUBSCRIPTION_TIME:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4datactrackprofilePackage.SUBSCRIBE__BASE_MESSAGE:
				if (resolve) return getBase_Message();
				return basicGetBase_Message();
			case Model4datactrackprofilePackage.SUBSCRIBE__DATA:
				if (resolve) return getData();
				return basicGetData();
			case Model4datactrackprofilePackage.SUBSCRIBE__MACHINES:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case Model4datactrackprofilePackage.SUBSCRIBE__BREACHES:
				getBreaches().clear();
				getBreaches().addAll((Collection<? extends breachInfo>)newValue);
				return;
			case Model4datactrackprofilePackage.SUBSCRIBE__MAX_SUBSCRIPTION_TIME:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Model4datactrackprofilePackage.SUBSCRIBE___MAX_SUB_TIME_GREATER_THAN_0__DIAGNOSTICCHAIN_MAP:
				return maxSubTime_greater_than_0((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Model4datactrackprofilePackage.SUBSCRIBE___MACHINE_CONTAINS_DATA_TO_SUBSCRIBE_TO__DIAGNOSTICCHAIN_MAP:
				return machine_contains_data_to_subscribe_to((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Model4datactrackprofilePackage.SUBSCRIBE___SUBSCRIBE_DESTINATION_MACHINES_COMPLY_WITH_GDPR__DIAGNOSTICCHAIN_MAP:

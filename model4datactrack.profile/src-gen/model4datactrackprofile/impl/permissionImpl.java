 ...
 * </p>
 * <ul>
 *   <li>{@link model4datactrackprofile.impl.permissionImpl#getBase_Message <em>Base Message</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.permissionImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.permissionImpl#getPermissionType <em>Permission Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class permissionImpl extends MinimalEObjectImpl.Container implements permission {
	...
	protected EClass eStaticClass() {
		return Model4datactrackprofilePackage.Literals.PERMISSION;
	}
		...
		if (base_Message != null && base_Message.eIsProxy()) {
			...
			if (base_Message != oldBase_Message) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4datactrackprofilePackage.PERMISSION__BASE_MESSAGE, oldBase_Message, base_Message));
			}
		}
		return base_Message;
	}
	...
	public void setBase_Message(Message newBase_Message) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.PERMISSION__BASE_MESSAGE, oldBase_Message, base_Message));
	}
	...
	public EList<String> getPurpose() {
		if (purpose == null) {
			purpose = new EDataTypeUniqueEList<String>(String.class, this, Model4datactrackprofilePackage.PERMISSION__PURPOSE);
		}
		return purpose;
	}
	...
	public void setPermissionType(ActionType newPermissionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.PERMISSION__PERMISSION_TYPE, oldPermissionType, permissionType));
	}
	 ...
	 * @generated
	 */
	public boolean no_access_permission_given_without_user_consent(DiagnosticChain diagnostics, Map<Object, Object> context) {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Model4datactrackprofileValidator.PERMISSION__NO_ACCESS_PERMISSION_GIVEN_WITHOUT_USER_CONSENT,
						 EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", new Object[] { "no_access_permission_given_without_user_consent", EObjectValidator.getObjectLabel(this, context) }),
						 new Object [] { this }));
			}
			return false;
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4datactrackprofilePackage.PERMISSION__BASE_MESSAGE:
				if (resolve) return getBase_Message();
				return basicGetBase_Message();
			case Model4datactrackprofilePackage.PERMISSION__PURPOSE:
				return getPurpose();
			case Model4datactrackprofilePackage.PERMISSION__PERMISSION_TYPE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Model4datactrackprofilePackage.PERMISSION___NO_ACCESS_PERMISSION_GIVEN_WITHOUT_USER_CONSENT__DIAGNOSTICCHAIN_MAP:
				return no_access_permission_given_without_user_consent((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}

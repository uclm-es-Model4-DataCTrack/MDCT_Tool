 ...
 * </p>
 * <ul>
 *   <li>{@link model4datactrackprofile.impl.SLAImpl#getBase_Class <em>Base Class</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.SLAImpl#getSubjectMatter <em>Subject Matter</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.SLAImpl#getProcessingDuration <em>Processing Duration</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.SLAImpl#getBase_Component <em>Base Component</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.SLAImpl#getRecipients <em>Recipients</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.SLAImpl#getProcessingNature <em>Processing Nature</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.SLAImpl#getProcessingPurpose <em>Processing Purpose</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.SLAImpl#getProcessingInstructions <em>Processing Instructions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SLAImpl extends MinimalEObjectImpl.Container implements SLA {
	...
	protected EClass eStaticClass() {
		return Model4datactrackprofilePackage.Literals.SLA;
	}
		...
		if (base_Class != null && base_Class.eIsProxy()) {
			...
			if (base_Class != oldBase_Class) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4datactrackprofilePackage.SLA__BASE_CLASS, oldBase_Class, base_Class));
			}
		}
		return base_Class;
	}
	...
	public void setBase_Class(org.eclipse.uml2.uml.Class newBase_Class) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.SLA__BASE_CLASS, oldBase_Class, base_Class));
	}
	...
	public EList<String> getSubjectMatter() {
		if (subjectMatter == null) {
			subjectMatter = new EDataTypeUniqueEList<String>(String.class, this, Model4datactrackprofilePackage.SLA__SUBJECT_MATTER);
		}
	...
	public NotificationChain basicSetProcessingDuration(Time newProcessingDuration, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.SLA__PROCESSING_DURATION, oldProcessingDuration, newProcessingDuration);
	...
	public void setProcessingDuration(Time newProcessingDuration) {
		if (newProcessingDuration != processingDuration) {
			...
			if (processingDuration != null)
				msgs = ((InternalEObject)processingDuration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Model4datactrackprofilePackage.SLA__PROCESSING_DURATION, null, msgs);
			if (newProcessingDuration != null)
				msgs = ((InternalEObject)newProcessingDuration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Model4datactrackprofilePackage.SLA__PROCESSING_DURATION, null, msgs);
			msgs = basicSetProcessingDuration(newProcessingDuration, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.SLA__PROCESSING_DURATION, newProcessingDuration, newProcessingDuration));
	}
	...
	public Component getBase_Component() {
		if (base_Component != null && base_Component.eIsProxy()) {
			...
			if (base_Component != oldBase_Component) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4datactrackprofilePackage.SLA__BASE_COMPONENT, oldBase_Component, base_Component));
			}
		}
	...
	public void setBase_Component(Component newBase_Component) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.SLA__BASE_COMPONENT, oldBase_Component, base_Component));
	}
	...
	public EList<StatelessAppCTP> getRecipients() {
		if (recipients == null) {
			recipients = new EObjectResolvingEList<StatelessAppCTP>(StatelessAppCTP.class, this, Model4datactrackprofilePackage.SLA__RECIPIENTS);
		}
		return recipients;
	}
	...
	public EList<String> getProcessingNature() {
		if (processingNature == null) {
			processingNature = new EDataTypeUniqueEList<String>(String.class, this, Model4datactrackprofilePackage.SLA__PROCESSING_NATURE);
		}
	...
	public EList<String> getProcessingPurpose() {
		if (processingPurpose == null) {
			processingPurpose = new EDataTypeUniqueEList<String>(String.class, this, Model4datactrackprofilePackage.SLA__PROCESSING_PURPOSE);
		}
	...
	public EList<String> getProcessingInstructions() {
		if (processingInstructions == null) {
			processingInstructions = new EDataTypeUniqueEList<String>(String.class, this, Model4datactrackprofilePackage.SLA__PROCESSING_INSTRUCTIONS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Model4datactrackprofilePackage.SLA__PROCESSING_DURATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4datactrackprofilePackage.SLA__BASE_CLASS:
				if (resolve) return getBase_Class();
				return basicGetBase_Class();
			case Model4datactrackprofilePackage.SLA__SUBJECT_MATTER:
				return getSubjectMatter();
			case Model4datactrackprofilePackage.SLA__PROCESSING_DURATION:
				return getProcessingDuration();
			case Model4datactrackprofilePackage.SLA__BASE_COMPONENT:
				if (resolve) return getBase_Component();
				return basicGetBase_Component();
			case Model4datactrackprofilePackage.SLA__RECIPIENTS:
				return getRecipients();
			case Model4datactrackprofilePackage.SLA__PROCESSING_NATURE:
				return getProcessingNature();
			case Model4datactrackprofilePackage.SLA__PROCESSING_PURPOSE:
				return getProcessingPurpose();
			case Model4datactrackprofilePackage.SLA__PROCESSING_INSTRUCTIONS:

 ...
 * </p>
 * <ul>
 *   <li>{@link model4datactrackprofile.impl.AccesPerTPImpl#getTp <em>Tp</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.AccesPerTPImpl#getActionPerformed <em>Action Performed</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.AccesPerTPImpl#getPurpose <em>Purpose</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AccesPerTPImpl extends MinimalEObjectImpl.Container implements AccesPerTP {
	...
	protected EClass eStaticClass() {
		return Model4datactrackprofilePackage.Literals.ACCES_PER_TP;
	}
		...
		if (tp != null && tp.eIsProxy()) {
			...
			if (tp != oldTp) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4datactrackprofilePackage.ACCES_PER_TP__TP, oldTp, tp));
			}
		}
		return tp;
	}
	...
	public void setTp(StatelessAppCTP newTp) {
		...
		tp = newTp;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.ACCES_PER_TP__TP, oldTp, tp));
	}
	...
	public void setActionPerformed(ActionType newActionPerformed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.ACCES_PER_TP__ACTION_PERFORMED, oldActionPerformed, actionPerformed));
	}
	...
	public EList<String> getPurpose() {
		if (purpose == null) {
			purpose = new EDataTypeUniqueEList<String>(String.class, this, Model4datactrackprofilePackage.ACCES_PER_TP__PURPOSE);
		}
		return purpose;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4datactrackprofilePackage.ACCES_PER_TP__TP:
				if (resolve) return getTp();
				return basicGetTp();
			case Model4datactrackprofilePackage.ACCES_PER_TP__ACTION_PERFORMED:
				return getActionPerformed();
			case Model4datactrackprofilePackage.ACCES_PER_TP__PURPOSE:
				return getPurpose();
		}

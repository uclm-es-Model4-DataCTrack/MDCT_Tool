...
import model4datactrackprofile.AccesPerTP;
...
import model4datactrackprofile.BandwidthUnit;
import model4datactrackprofile.ComputingRack;
...
import model4datactrackprofile.Hardware;
import model4datactrackprofile.Info;
import model4datactrackprofile.Infrastructure;
import model4datactrackprofile.Latency;
import model4datactrackprofile.Machine;
import model4datactrackprofile.Memory;
import model4datactrackprofile.Model4datactrackprofileFactory;
...
import model4datactrackprofile.RackElement;
import model4datactrackprofile.SSMProcessor;
import model4datactrackprofile.Size;
import model4datactrackprofile.SizeUnit;
import model4datactrackprofile.StatelessAppCTP;
import model4datactrackprofile.StatelessComputationMachine;
...
import model4datactrackprofile.TimeUnit;
import model4datactrackprofile.TrustedSCM;
import model4datactrackprofile.UntrustedSCM;
import model4datactrackprofile.User;
import model4datactrackprofile.accessInformation;
import model4datactrackprofile.askAuthentication;
import model4datactrackprofile.askDataInformation;
import model4datactrackprofile.breachInfo;
import model4datactrackprofile.checkChanges;
import model4datactrackprofile.consent;
import model4datactrackprofile.consentInfo;
import model4datactrackprofile.eraseData;
import model4datactrackprofile.informBreaches;
import model4datactrackprofile.informationNotForFree;
import model4datactrackprofile.newData;
import model4datactrackprofile.newRestrictions;
import model4datactrackprofile.notify;
import model4datactrackprofile.ok;
import model4datactrackprofile.permission;
import model4datactrackprofile.readData;
import model4datactrackprofile.rectifyData;
import model4datactrackprofile.removeData;
import model4datactrackprofile.removeSPInLog;
import model4datactrackprofile.reportDataDManagementForFree;
import model4datactrackprofile.reportDataManagement;
import model4datactrackprofile.sendData;
import model4datactrackprofile.subscribe;
import model4datactrackprofile.timeoutSubscription;
...
import model4datactrackprofile.wantToAccess;
 ...
 * @generated
 */
public class Model4datactrackprofilePackageImpl extends EPackageImpl implements Model4datactrackprofilePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass breachInfoEClass = null;
	 ...
	 * @see model4datactrackprofile.Model4datactrackprofilePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Model4datactrackprofilePackageImpl() {
		super(eNS_URI, Model4datactrackprofileFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link Model4datactrackprofilePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Model4datactrackprofilePackage init() {
		if (isInited) return (Model4datactrackprofilePackage)EPackage.Registry.INSTANCE.getEPackage(Model4datactrackprofilePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredModel4datactrackprofilePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		Model4datactrackprofilePackageImpl theModel4datactrackprofilePackage = registeredModel4datactrackprofilePackage instanceof Model4datactrackprofilePackageImpl ? (Model4datactrackprofilePackageImpl)registeredModel4datactrackprofilePackage : new Model4datactrackprofilePackageImpl();
		...
		theModel4datactrackprofilePackage.createPackageContents();

		// Initialize created meta-data
		theModel4datactrackprofilePackage.initializePackageContents();

		// Register package validator
		EValidator.Registry.INSTANCE.put
			(theModel4datactrackprofilePackage,
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return Model4datactrackprofileValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		theModel4datactrackprofilePackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Model4datactrackprofilePackage.eNS_URI, theModel4datactrackprofilePackage);
		return theModel4datactrackprofilePackage;
	}
	 ...
	 * @generated
	 */
	public EReference getsubscribe_Breaches() {
		return (EReference)subscribeEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EClass getbreachInfo() {
		return breachInfoEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getbreachInfo_Data() {
		return (EReference)breachInfoEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getbreachInfo_Tp() {
		return (EReference)breachInfoEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getbreachInfo_Action() {
		return (EAttribute)breachInfoEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getbreachInfo_NewData() {
		return (EReference)breachInfoEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getbreachInfo_NewLocation() {
		return (EReference)breachInfoEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public Model4datactrackprofileFactory getModel4datactrackprofileFactory() {
		return (Model4datactrackprofileFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(subscribeEClass, SUBSCRIBE__BREACHES);
		...
		breachInfoEClass = createEClass(BREACH_INFO);
		createEReference(breachInfoEClass, BREACH_INFO__DATA);
		createEReference(breachInfoEClass, BREACH_INFO__TP);
		createEAttribute(breachInfoEClass, BREACH_INFO__ACTION);
		createEReference(breachInfoEClass, BREACH_INFO__NEW_DATA);
		createEReference(breachInfoEClass, BREACH_INFO__NEW_LOCATION);
	...
	public void initializePackageContents() {
		...
		initEClass(slaEClass, model4datactrackprofile.SLA.class, "SLA", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSLA_Base_Class(), theUMLPackage.getClass_(), null, "base_Class", null, 0, 1, model4datactrackprofile.SLA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getSLA_SubjectMatter(), theTypesPackage.getString(), "subjectMatter", null, 1, -1, model4datactrackprofile.SLA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSLA_ProcessingDuration(), this.getTime(), null, "processingDuration", null, 1, 1, model4datactrackprofile.SLA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSLA_Base_Component(), theUMLPackage.getComponent(), null, "base_Component", null, 0, 1, model4datactrackprofile.SLA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSLA_Recipients(), this.getStatelessAppCTP(), null, "recipients", null, 1, -1, model4datactrackprofile.SLA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getSLA_ProcessingNature(), theTypesPackage.getString(), "processingNature", null, 1, -1, model4datactrackprofile.SLA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getSLA_ProcessingPurpose(), theTypesPackage.getString(), "processingPurpose", null, 1, -1, model4datactrackprofile.SLA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getSLA_ProcessingInstructions(), theTypesPackage.getString(), "processingInstructions", null, 1, -1, model4datactrackprofile.SLA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(cpuEClass, model4datactrackprofile.CPU.class, "CPU", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCPU_Cores(), theTypesPackage.getInteger(), "cores", null, 1, 1, model4datactrackprofile.CPU.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getCPU_FLOPs(), theTypesPackage.getReal(), "FLOPs", "0.0", 1, 1, model4datactrackprofile.CPU.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getsubscribe_Breaches(), this.getbreachInfo(), null, "breaches", null, 1, -1, subscribe.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(breachInfoEClass, breachInfo.class, "breachInfo", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getbreachInfo_Data(), this.getData(), null, "data", null, 1, 1, breachInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getbreachInfo_Tp(), this.getStatelessAppCTP(), null, "tp", null, 1, 1, breachInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getbreachInfo_Action(), this.getActionType(), "action", null, 1, 1, breachInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getbreachInfo_NewData(), this.getData(), null, "newData", null, 1, 1, breachInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getbreachInfo_NewLocation(), this.getStorage(), null, "newLocation", null, 1, 1, breachInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(spEClass, model4datactrackprofile.SP.class, "SP", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSP_Base_Message(), theUMLPackage.getMessage(), null, "base_Message", null, 0, 1, model4datactrackprofile.SP.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
	...
	protected void createUMLAnnotations() {
		...
		addAnnotation
		  (this,
		   source,
		   new String[] {
			   "originalName", "model4datactrack.profile"
		   });
	}

} //Model4datactrackprofilePackageImpl

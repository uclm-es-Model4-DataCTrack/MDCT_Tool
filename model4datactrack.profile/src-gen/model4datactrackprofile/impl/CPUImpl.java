 ...
 * </p>
 * <ul>
 *   <li>{@link model4datactrackprofile.impl.CPUImpl#getCores <em>Cores</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.CPUImpl#getFLOPs <em>FLO Ps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CPUImpl extends HardwareImpl implements CPU {
	...
	protected EClass eStaticClass() {
		return Model4datactrackprofilePackage.Literals.CPU;
	}
	...
	public void setCores(int newCores) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.CPU__CORES, oldCores, cores));
	}
	...
	public void setFLOPs(double newFLOPs) {
		...
		floPs = newFLOPs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.CPU__FLO_PS, oldFLOPs, floPs));
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Model4datactrackprofileValidator.CPU__CPU_CORES_AND_FLOPS_GREATER_THAN_0,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4datactrackprofilePackage.CPU__CORES:
				return getCores();
			case Model4datactrackprofilePackage.CPU__FLO_PS:
				return getFLOPs();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Model4datactrackprofilePackage.CPU___CPU_CORES_AND_FLOPS_GREATER_THAN_0__DIAGNOSTICCHAIN_MAP:

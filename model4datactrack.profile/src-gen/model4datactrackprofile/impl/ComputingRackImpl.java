 ...
 * </p>
 * <ul>
 *   <li>{@link model4datactrackprofile.impl.ComputingRackImpl#getMachineType <em>Machine Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComputingRackImpl extends RackImpl implements ComputingRack {
	...
	protected EClass eStaticClass() {
		return Model4datactrackprofilePackage.Literals.COMPUTING_RACK;
	}
		...
		if (machineType != null && machineType.eIsProxy()) {
			...
			if (machineType != oldMachineType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4datactrackprofilePackage.COMPUTING_RACK__MACHINE_TYPE, oldMachineType, machineType));
			}
		}
		return machineType;
	}
	...
	public void setMachineType(StatelessComputationMachine newMachineType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.COMPUTING_RACK__MACHINE_TYPE, oldMachineType, machineType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4datactrackprofilePackage.COMPUTING_RACK__MACHINE_TYPE:

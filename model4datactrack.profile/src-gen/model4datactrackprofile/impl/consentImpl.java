 ...
 * </p>
 * <ul>
 *   <li>{@link model4datactrackprofile.impl.consentImpl#getBase_Message <em>Base Message</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.consentImpl#getData <em>Data</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.consentImpl#getAction <em>Action</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.consentImpl#getPurpose <em>Purpose</em>}</li>
 * </ul>
 *
 * @generated
 */
public class consentImpl extends MinimalEObjectImpl.Container implements consent {
	...
	protected EClass eStaticClass() {
		return Model4datactrackprofilePackage.Literals.CONSENT;
	}
		...
		if (base_Message != null && base_Message.eIsProxy()) {
			...
			if (base_Message != oldBase_Message) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4datactrackprofilePackage.CONSENT__BASE_MESSAGE, oldBase_Message, base_Message));
			}
		}
		return base_Message;
	}
	...
	public void setBase_Message(Message newBase_Message) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.CONSENT__BASE_MESSAGE, oldBase_Message, base_Message));
	}
	...
	public Data getData() {
		if (data != null && data.eIsProxy()) {
			...
			if (data != oldData) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4datactrackprofilePackage.CONSENT__DATA, oldData, data));
			}
		}
		return data;
	}
	...
	public void setData(Data newData) {
		...
		data = newData;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.CONSENT__DATA, oldData, data));
	}
	...
	public void setAction(ActionType newAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.CONSENT__ACTION, oldAction, action));
	}
	...
	public EList<String> getPurpose() {
		if (purpose == null) {
			purpose = new EDataTypeUniqueEList<String>(String.class, this, Model4datactrackprofilePackage.CONSENT__PURPOSE);
		}
		return purpose;
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Model4datactrackprofileValidator.CONSENT__CONSENT_MACHINE_COMPLIES_WITH_GDPR,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4datactrackprofilePackage.CONSENT__BASE_MESSAGE:
				if (resolve) return getBase_Message();
				return basicGetBase_Message();
			case Model4datactrackprofilePackage.CONSENT__DATA:
				if (resolve) return getData();
				return basicGetData();
			case Model4datactrackprofilePackage.CONSENT__ACTION:
				return getAction();
			case Model4datactrackprofilePackage.CONSENT__PURPOSE:
				return getPurpose();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Model4datactrackprofilePackage.CONSENT___CONSENT_MACHINE_COMPLIES_WITH_GDPR__DIAGNOSTICCHAIN_MAP:

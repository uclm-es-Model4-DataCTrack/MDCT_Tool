 ...
 * </p>
 * <ul>
 *   <li>{@link model4datactrackprofile.impl.accessInformationImpl#getBase_Message <em>Base Message</em>}</li>
 * </ul>
 *
 * @generated
 */
public class accessInformationImpl extends MinimalEObjectImpl.Container implements accessInformation {
	...
	protected EClass eStaticClass() {
		return Model4datactrackprofilePackage.Literals.ACCESS_INFORMATION;
	}
		...
		if (base_Message != null && base_Message.eIsProxy()) {
			...
			if (base_Message != oldBase_Message) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4datactrackprofilePackage.ACCESS_INFORMATION__BASE_MESSAGE, oldBase_Message, base_Message));
			}
		}
		return base_Message;
	}
	...
	public void setBase_Message(Message newBase_Message) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.ACCESS_INFORMATION__BASE_MESSAGE, oldBase_Message, base_Message));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4datactrackprofilePackage.ACCESS_INFORMATION__BASE_MESSAGE:

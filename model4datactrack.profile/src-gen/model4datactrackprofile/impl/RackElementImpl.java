 ...
 * </p>
 * <ul>
 *   <li>{@link model4datactrackprofile.impl.RackElementImpl#getNumberOfRacks <em>Number Of Racks</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.RackElementImpl#getRackType <em>Rack Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RackElementImpl extends MinimalEObjectImpl.Container implements RackElement {
	...
	protected EClass eStaticClass() {
		return Model4datactrackprofilePackage.Literals.RACK_ELEMENT;
	}
	...
	public void setNumberOfRacks(int newNumberOfRacks) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.RACK_ELEMENT__NUMBER_OF_RACKS, oldNumberOfRacks, numberOfRacks));
	}
	...
	public Rack getRackType() {
		if (rackType != null && rackType.eIsProxy()) {
			...
			if (rackType != oldRackType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4datactrackprofilePackage.RACK_ELEMENT__RACK_TYPE, oldRackType, rackType));
			}
		}
		return rackType;
	}
	...
	public void setRackType(Rack newRackType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.RACK_ELEMENT__RACK_TYPE, oldRackType, rackType));
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Model4datactrackprofileValidator.RACK_ELEMENT__NO_EMPTY_DATACENTERS,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4datactrackprofilePackage.RACK_ELEMENT__NUMBER_OF_RACKS:
				return getNumberOfRacks();
			case Model4datactrackprofilePackage.RACK_ELEMENT__RACK_TYPE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Model4datactrackprofilePackage.RACK_ELEMENT___NO_EMPTY_DATACENTERS__DIAGNOSTICCHAIN_MAP:

 ...
 * </p>
 * <ul>
 *   <li>{@link model4datactrackprofile.impl.newDataImpl#getBase_Message <em>Base Message</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.newDataImpl#getData <em>Data</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.newDataImpl#getMachines <em>Machines</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.newDataImpl#getNewData <em>New Data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class newDataImpl extends MinimalEObjectImpl.Container implements newData {
	...
	protected EClass eStaticClass() {
		return Model4datactrackprofilePackage.Literals.NEW_DATA;
	}
		...
		if (base_Message != null && base_Message.eIsProxy()) {
			...
			if (base_Message != oldBase_Message) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4datactrackprofilePackage.NEW_DATA__BASE_MESSAGE, oldBase_Message, base_Message));
			}
		}
		return base_Message;
	}
	...
	public void setBase_Message(Message newBase_Message) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.NEW_DATA__BASE_MESSAGE, oldBase_Message, base_Message));
	}
	...
	public Data getData() {
		if (data != null && data.eIsProxy()) {
			...
			if (data != oldData) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4datactrackprofilePackage.NEW_DATA__DATA, oldData, data));
			}
		}
		return data;
	}
	...
	public void setData(Data newData) {
		...
		data = newData;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.NEW_DATA__DATA, oldData, data));
	}
	...
	public EList<SSMProcessor> getMachines() {
		if (machines == null) {
			machines = new EObjectResolvingEList<SSMProcessor>(SSMProcessor.class, this, Model4datactrackprofilePackage.NEW_DATA__MACHINES);
		}
		return machines;
	}
	...
	public EList<DataField> getNewData() {
		if (newData == null) {
			newData = new EObjectContainmentEList<DataField>(DataField.class, this, Model4datactrackprofilePackage.NEW_DATA__NEW_DATA);
		}
		return newData;
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Model4datactrackprofileValidator.NEW_DATA__NO_EMPTY_NEW_DATA_FIELDS,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Model4datactrackprofileValidator.DIAGNOSTIC_SOURCE,
						 Model4datactrackprofileValidator.NEW_DATA__MACHINE_CONTAINS_DATA_TO_RECTIFY,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Model4datactrackprofileValidator.DIAGNOSTIC_SOURCE,
						 Model4datactrackprofileValidator.NEW_DATA__NEW_DATA_DESTINATION_MACHINES_COMPLY_WITH_GDPR,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Model4datactrackprofilePackage.NEW_DATA__NEW_DATA:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4datactrackprofilePackage.NEW_DATA__BASE_MESSAGE:
				if (resolve) return getBase_Message();
				return basicGetBase_Message();
			case Model4datactrackprofilePackage.NEW_DATA__DATA:
				if (resolve) return getData();
				return basicGetData();
			case Model4datactrackprofilePackage.NEW_DATA__MACHINES:
				return getMachines();
			case Model4datactrackprofilePackage.NEW_DATA__NEW_DATA:
				return getNewData();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Model4datactrackprofilePackage.NEW_DATA___NO_EMPTY_NEW_DATA_FIELDS__DIAGNOSTICCHAIN_MAP:
				return no_empty_newData_fields((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Model4datactrackprofilePackage.NEW_DATA___MACHINE_CONTAINS_DATA_TO_RECTIFY__DIAGNOSTICCHAIN_MAP:
				return machine_contains_data_to_rectify((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Model4datactrackprofilePackage.NEW_DATA___NEW_DATA_DESTINATION_MACHINES_COMPLY_WITH_GDPR__DIAGNOSTICCHAIN_MAP:

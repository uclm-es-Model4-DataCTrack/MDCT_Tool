 ...
 * </p>
 * <ul>
 *   <li>{@link model4datactrackprofile.impl.okImpl#getBase_Message <em>Base Message</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.okImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link model4datactrackprofile.impl.okImpl#getPermissionType <em>Permission Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class okImpl extends MinimalEObjectImpl.Container implements ok {
	...
	protected EClass eStaticClass() {
		return Model4datactrackprofilePackage.Literals.OK;
	}
		...
		if (base_Message != null && base_Message.eIsProxy()) {
			...
			if (base_Message != oldBase_Message) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4datactrackprofilePackage.OK__BASE_MESSAGE, oldBase_Message, base_Message));
			}
		}
		return base_Message;
	}
	...
	public void setBase_Message(Message newBase_Message) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.OK__BASE_MESSAGE, oldBase_Message, base_Message));
	}
	...
	public EList<String> getPurpose() {
		if (purpose == null) {
			purpose = new EDataTypeUniqueEList<String>(String.class, this, Model4datactrackprofilePackage.OK__PURPOSE);
		}
		return purpose;
	}
	...
	public void setPermissionType(ActionType newPermissionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4datactrackprofilePackage.OK__PERMISSION_TYPE, oldPermissionType, permissionType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4datactrackprofilePackage.OK__BASE_MESSAGE:
				if (resolve) return getBase_Message();
				return basicGetBase_Message();
			case Model4datactrackprofilePackage.OK__PURPOSE:
				return getPurpose();
			case Model4datactrackprofilePackage.OK__PERMISSION_TYPE:

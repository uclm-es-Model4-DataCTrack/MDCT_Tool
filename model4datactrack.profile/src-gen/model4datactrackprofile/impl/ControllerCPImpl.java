...
public class ControllerCPImpl extends MinimalEObjectImpl.Container implements ControllerCP {
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Model4datactrackprofileValidator.CONTROLLER_CP__NEW_LOCATION_MACHINE_NOT_UNDER_SLA_WITH_CONTROLLER,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Model4datactrackprofileValidator.DIAGNOSTIC_SOURCE,
						 Model4datactrackprofileValidator.CONTROLLER_CP__LOCATION1_MACHINE_NOT_UNDER_SLA_WITH_CONTROLLER,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Model4datactrackprofilePackage.CONTROLLER_CP___NEW_LOCATION_MACHINE_NOT_UNDER_SLA_WITH_CONTROLLER__DIAGNOSTICCHAIN_MAP:
			...
			case Model4datactrackprofilePackage.CONTROLLER_CP___LOCATION1_MACHINE_NOT_UNDER_SLA_WITH_CONTROLLER__DIAGNOSTICCHAIN_MAP:

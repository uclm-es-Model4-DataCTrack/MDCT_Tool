 ...
 * </p>
 * <ul>
 *   <li>{@link model4datactrackprofile.notify#getBase_Message <em>Base Message</em>}</li>
 *   <li>{@link model4datactrackprofile.notify#getData <em>Data</em>}</li>
 *   <li>{@link model4datactrackprofile.notify#getMachines <em>Machines</em>}</li>
 *   <li>{@link model4datactrackprofile.notify#getBreaches <em>Breaches</em>}</li>
 * </ul>
 *
 * @see model4datactrackprofile.Model4datactrackprofilePackage#getnotify()
 * @model
 * @generated
 */
public interface notify extends EObject {
	 ...
	 * @see model4datactrackprofile.Model4datactrackprofilePackage#getnotify_Base_Message()
	 * @model ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link model4datactrackprofile.notify#getBase_Message <em>Base Message</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setData(Data)
	 * @see model4datactrackprofile.Model4datactrackprofilePackage#getnotify_Data()
	...
	/**
	 * Sets the value of the '{@link model4datactrackprofile.notify#getData <em>Data</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see model4datactrackprofile.Model4datactrackprofilePackage#getnotify_Machines()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	 ...
	 * @see model4datactrackprofile.Model4datactrackprofilePackage#getnotify_Breaches()

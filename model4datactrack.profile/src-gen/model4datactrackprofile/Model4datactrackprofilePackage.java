...
public interface Model4datactrackprofilePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int CONTROLLER_CP_OPERATION_COUNT = 0;
	...
	/**
	 * The feature id for the '<em><b>Breaches</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	...
	/**
	 * The meta object id for the '{@link model4datactrackprofile.impl.breachInfoImpl <em>breach Info</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see model4datactrackprofile.impl.breachInfoImpl
	 * @see model4datactrackprofile.impl.Model4datactrackprofilePackageImpl#getbreachInfo()
	 * @generated
	 */
	int BREACH_INFO = 47;
	 ...
	 * @ordered
	 */
	int BREACH_INFO__ACTION = 2;

	/**
	 * The feature id for the '<em><b>New Data</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int BREACH_INFO__NEW_DATA = 3;

	/**
	 * The feature id for the '<em><b>New Location</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int BREACH_INFO__NEW_LOCATION = 4;

	/**
	 * The number of structural features of the '<em>breach Info</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int BREACH_INFO_FEATURE_COUNT = 5;

	/**
	 * The number of operations of the '<em>breach Info</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int BREACH_INFO_OPERATION_COUNT = 0;
	 ...
	 * @generated
	 */
	int INFORMATION_NOT_FOR_FREE = 58;
	 ...
	 * @generated
	 */
	int REPORT_DATA_DMANAGEMENT_FOR_FREE = 60;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link model4datactrackprofile.subscribe#getBreaches <em>Breaches</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Breaches</em>'.
	 * @see model4datactrackprofile.subscribe#getBreaches()
	 * @see #getsubscribe()
	 * @generated
	 */
	EReference getsubscribe_Breaches();
	...
	/**
	 * Returns the meta object for class '{@link model4datactrackprofile.breachInfo <em>breach Info</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>breach Info</em>'.
	 * @see model4datactrackprofile.breachInfo
	 * @generated
	 */
	EClass getbreachInfo();

	/**
	 * Returns the meta object for the reference '{@link model4datactrackprofile.breachInfo#getData <em>Data</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Data</em>'.
	 * @see model4datactrackprofile.breachInfo#getData()
	 * @see #getbreachInfo()
	 * @generated
	 */
	EReference getbreachInfo_Data();

	/**
	 * Returns the meta object for the reference '{@link model4datactrackprofile.breachInfo#getTp <em>Tp</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Tp</em>'.
	 * @see model4datactrackprofile.breachInfo#getTp()
	 * @see #getbreachInfo()
	 * @generated
	 */
	EReference getbreachInfo_Tp();

	/**
	 * Returns the meta object for the attribute '{@link model4datactrackprofile.breachInfo#getAction <em>Action</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Action</em>'.
	 * @see model4datactrackprofile.breachInfo#getAction()
	 * @see #getbreachInfo()
	 * @generated
	 */
	EAttribute getbreachInfo_Action();

	/**
	 * Returns the meta object for the reference '{@link model4datactrackprofile.breachInfo#getNewData <em>New Data</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>New Data</em>'.
	 * @see model4datactrackprofile.breachInfo#getNewData()
	 * @see #getbreachInfo()
	 * @generated
	 */
	EReference getbreachInfo_NewData();

	/**
	 * Returns the meta object for the reference '{@link model4datactrackprofile.breachInfo#getNewLocation <em>New Location</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>New Location</em>'.
	 * @see model4datactrackprofile.breachInfo#getNewLocation()
	 * @see #getbreachInfo()
	 * @generated
	 */
	EReference getbreachInfo_NewLocation();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Breaches</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference SUBSCRIBE__BREACHES = eINSTANCE.getsubscribe_Breaches();
		...
		/**
		 * The meta object literal for the '{@link model4datactrackprofile.impl.breachInfoImpl <em>breach Info</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see model4datactrackprofile.impl.breachInfoImpl
		 * @see model4datactrackprofile.impl.Model4datactrackprofilePackageImpl#getbreachInfo()
		 * @generated
		 */
		EClass BREACH_INFO = eINSTANCE.getbreachInfo();
		 ...
		 * @generated
		 */
		EReference BREACH_INFO__DATA = eINSTANCE.getbreachInfo_Data();
		 ...
		 * @generated
		 */
		EReference BREACH_INFO__TP = eINSTANCE.getbreachInfo_Tp();
		 ...
		 * @generated
		 */
		EAttribute BREACH_INFO__ACTION = eINSTANCE.getbreachInfo_Action();

		/**
		 * The meta object literal for the '<em><b>New Data</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference BREACH_INFO__NEW_DATA = eINSTANCE.getbreachInfo_NewData();

		/**
		 * The meta object literal for the '<em><b>New Location</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference BREACH_INFO__NEW_LOCATION = eINSTANCE.getbreachInfo_NewLocation();

 ...
 * </p>
 * <ul>
 *   <li>{@link Model4DataCtrack.impl.writeDataImpl#getBase_Message <em>Base Message</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.writeDataImpl#getNewData <em>New Data</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.writeDataImpl#getMaxTime <em>Max Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class writeDataImpl extends MinimalEObjectImpl.Container implements writeData {
	...
	protected EClass eStaticClass() {
		return Model4DataCtrackPackage.Literals.WRITE_DATA;
	}
		...
		if (base_Message != null && base_Message.eIsProxy()) {
			...
			if (base_Message != oldBase_Message) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.WRITE_DATA__BASE_MESSAGE, oldBase_Message, base_Message));
			}
		}
		return base_Message;
	}
	...
	public void setBase_Message(Message newBase_Message) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.WRITE_DATA__BASE_MESSAGE, oldBase_Message, base_Message));
	}
	...
	public EList<DataField> getNewData() {
		if (newData == null) {
			newData = new EObjectContainmentEList<DataField>(DataField.class, this, Model4DataCtrackPackage.WRITE_DATA__NEW_DATA);
		}
		return newData;
	}
	...
	public NotificationChain basicSetMaxTime(Time newMaxTime, NotificationChain msgs) {
		...
		maxTime = newMaxTime;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.WRITE_DATA__MAX_TIME, oldMaxTime, newMaxTime);
	...
	public void setMaxTime(Time newMaxTime) {
		if (newMaxTime != maxTime) {
			...
			if (maxTime != null)
				msgs = ((InternalEObject)maxTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Model4DataCtrackPackage.WRITE_DATA__MAX_TIME, null, msgs);
			if (newMaxTime != null)
				msgs = ((InternalEObject)newMaxTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Model4DataCtrackPackage.WRITE_DATA__MAX_TIME, null, msgs);
			msgs = basicSetMaxTime(newMaxTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.WRITE_DATA__MAX_TIME, newMaxTime, newMaxTime));
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Model4DataCtrackValidator.WRITE_DATA__NO_EMPTY_WRITE_FIELDS,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Model4DataCtrackValidator.DIAGNOSTIC_SOURCE,
						 Model4DataCtrackValidator.WRITE_DATA__WRITE_DATA_TIMEUNIT_NOT_DAYS_OR_HOURS_OR_MINUTES,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Model4DataCtrackPackage.WRITE_DATA__NEW_DATA:
				return ((InternalEList<?>)getNewData()).basicRemove(otherEnd, msgs);
			case Model4DataCtrackPackage.WRITE_DATA__MAX_TIME:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4DataCtrackPackage.WRITE_DATA__BASE_MESSAGE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Model4DataCtrackPackage.WRITE_DATA___NO_EMPTY_WRITE_FIELDS__DIAGNOSTICCHAIN_MAP:
				return no_empty_write_fields((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Model4DataCtrackPackage.WRITE_DATA___WRITE_DATA_TIMEUNIT_NOT_DAYS_OR_HOURS_OR_MINUTES__DIAGNOSTICCHAIN_MAP:

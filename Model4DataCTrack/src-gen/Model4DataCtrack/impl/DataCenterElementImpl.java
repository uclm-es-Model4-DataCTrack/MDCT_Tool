 ...
 * </p>
 * <ul>
 *   <li>{@link Model4DataCtrack.impl.DataCenterElementImpl#getNumberOfDataCenters <em>Number Of Data Centers</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.DataCenterElementImpl#getDataCenterType <em>Data Center Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataCenterElementImpl extends MinimalEObjectImpl.Container implements DataCenterElement {
	...
	protected EClass eStaticClass() {
		return Model4DataCtrackPackage.Literals.DATA_CENTER_ELEMENT;
	}
	...
	public void setNumberOfDataCenters(int newNumberOfDataCenters) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.DATA_CENTER_ELEMENT__NUMBER_OF_DATA_CENTERS, oldNumberOfDataCenters, numberOfDataCenters));
	}
	...
	public DataCenter getDataCenterType() {
		if (dataCenterType != null && dataCenterType.eIsProxy()) {
			...
			if (dataCenterType != oldDataCenterType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.DATA_CENTER_ELEMENT__DATA_CENTER_TYPE, oldDataCenterType, dataCenterType));
			}
		}
	...
	public void setDataCenterType(DataCenter newDataCenterType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.DATA_CENTER_ELEMENT__DATA_CENTER_TYPE, oldDataCenterType, dataCenterType));
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Model4DataCtrackValidator.DATA_CENTER_ELEMENT__NO_EMPTY_INFRA,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4DataCtrackPackage.DATA_CENTER_ELEMENT__NUMBER_OF_DATA_CENTERS:
				return getNumberOfDataCenters();
			case Model4DataCtrackPackage.DATA_CENTER_ELEMENT__DATA_CENTER_TYPE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Model4DataCtrackPackage.DATA_CENTER_ELEMENT___NO_EMPTY_INFRA__DIAGNOSTICCHAIN_MAP:

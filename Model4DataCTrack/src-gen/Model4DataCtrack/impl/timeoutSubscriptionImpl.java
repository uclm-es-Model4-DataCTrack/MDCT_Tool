 ...
 * </p>
 * <ul>
 *   <li>{@link Model4DataCtrack.impl.timeoutSubscriptionImpl#getBase_Message <em>Base Message</em>}</li>
 * </ul>
 *
 * @generated
 */
public class timeoutSubscriptionImpl extends MinimalEObjectImpl.Container implements timeoutSubscription {
	...
	protected EClass eStaticClass() {
		return Model4DataCtrackPackage.Literals.TIMEOUT_SUBSCRIPTION;
	}
		...
		if (base_Message != null && base_Message.eIsProxy()) {
			...
			if (base_Message != oldBase_Message) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.TIMEOUT_SUBSCRIPTION__BASE_MESSAGE, oldBase_Message, base_Message));
			}
		}
		return base_Message;
	}
	...
	public void setBase_Message(Message newBase_Message) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.TIMEOUT_SUBSCRIPTION__BASE_MESSAGE, oldBase_Message, base_Message));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4DataCtrackPackage.TIMEOUT_SUBSCRIPTION__BASE_MESSAGE:

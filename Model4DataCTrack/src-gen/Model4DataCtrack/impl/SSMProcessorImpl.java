 ...
 * </p>
 * <ul>
 *   <li>{@link Model4DataCtrack.impl.SSMProcessorImpl#getBase_Lifeline <em>Base Lifeline</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.SSMProcessorImpl#getSla <em>Sla</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.SSMProcessorImpl#isGDPRCompliance <em>GDPR Compliance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SSMProcessorImpl extends MachineImpl implements SSMProcessor {
	...
	protected EClass eStaticClass() {
		return Model4DataCtrackPackage.Literals.SSM_PROCESSOR;
	}
		...
		if (base_Lifeline != null && base_Lifeline.eIsProxy()) {
			...
			if (base_Lifeline != oldBase_Lifeline) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.SSM_PROCESSOR__BASE_LIFELINE, oldBase_Lifeline, base_Lifeline));
			}
		}
	...
	public void setBase_Lifeline(Lifeline newBase_Lifeline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.SSM_PROCESSOR__BASE_LIFELINE, oldBase_Lifeline, base_Lifeline));
	}
	...
	public EList<SLA> getSla() {
		if (sla == null) {
			sla = new EObjectResolvingEList<SLA>(SLA.class, this, Model4DataCtrackPackage.SSM_PROCESSOR__SLA);
		}
		return sla;
	}
	...
	public void setGDPRCompliance(boolean newGDPRCompliance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.SSM_PROCESSOR__GDPR_COMPLIANCE, oldGDPRCompliance, gdprCompliance));
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Model4DataCtrackValidator.SSM_PROCESSOR__SSM_PROCCESSOR_COMPLIES_GDPR,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4DataCtrackPackage.SSM_PROCESSOR__BASE_LIFELINE:
				if (resolve) return getBase_Lifeline();
				return basicGetBase_Lifeline();
			case Model4DataCtrackPackage.SSM_PROCESSOR__SLA:
				return getSla();
			case Model4DataCtrackPackage.SSM_PROCESSOR__GDPR_COMPLIANCE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Model4DataCtrackPackage.SSM_PROCESSOR___SSM_PROCCESSOR_COMPLIES_GDPR__DIAGNOSTICCHAIN_MAP:

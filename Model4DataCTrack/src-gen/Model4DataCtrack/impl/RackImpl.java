 ...
 * </p>
 * <ul>
 *   <li>{@link Model4DataCtrack.impl.RackImpl#getBase_Component <em>Base Component</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.RackImpl#getMachinesPerBoard <em>Machines Per Board</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.RackImpl#getNetwork <em>Network</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.RackImpl#getBoards <em>Boards</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class RackImpl extends MinimalEObjectImpl.Container implements Rack {
	...
	protected EClass eStaticClass() {
		return Model4DataCtrackPackage.Literals.RACK;
	}
		...
		if (base_Component != null && base_Component.eIsProxy()) {
			...
			if (base_Component != oldBase_Component) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.RACK__BASE_COMPONENT, oldBase_Component, base_Component));
			}
		}
	...
	public void setBase_Component(Component newBase_Component) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.RACK__BASE_COMPONENT, oldBase_Component, base_Component));
	}
	...
	public void setMachinesPerBoard(int newMachinesPerBoard) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.RACK__MACHINES_PER_BOARD, oldMachinesPerBoard, machinesPerBoard));
	}
	...
	public NotificationChain basicSetNetwork(Bandwidth newNetwork, NotificationChain msgs) {
		...
		network = newNetwork;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.RACK__NETWORK, oldNetwork, newNetwork);
	...
	public void setNetwork(Bandwidth newNetwork) {
		if (newNetwork != network) {
			...
			if (network != null)
				msgs = ((InternalEObject)network).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Model4DataCtrackPackage.RACK__NETWORK, null, msgs);
			if (newNetwork != null)
				msgs = ((InternalEObject)newNetwork).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Model4DataCtrackPackage.RACK__NETWORK, null, msgs);
			msgs = basicSetNetwork(newNetwork, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.RACK__NETWORK, newNetwork, newNetwork));
	}
	...
	public void setBoards(int newBoards) {
		...
		boards = newBoards;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.RACK__BOARDS, oldBoards, boards));
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Model4DataCtrackValidator.RACK__NO_EMPTY_RACKS,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Model4DataCtrackPackage.RACK__NETWORK:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4DataCtrackPackage.RACK__BASE_COMPONENT:
				if (resolve) return getBase_Component();
				return basicGetBase_Component();
			case Model4DataCtrackPackage.RACK__MACHINES_PER_BOARD:
				return getMachinesPerBoard();
			case Model4DataCtrackPackage.RACK__NETWORK:
				return getNetwork();
			case Model4DataCtrackPackage.RACK__BOARDS:
				return getBoards();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Model4DataCtrackPackage.RACK___NO_EMPTY_RACKS__DIAGNOSTICCHAIN_MAP:

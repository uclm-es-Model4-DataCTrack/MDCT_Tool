 ...
 * </p>
 * <ul>
 *   <li>{@link Model4DataCtrack.impl.permissionImpl#getBase_Message <em>Base Message</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.permissionImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.permissionImpl#getPermissionType <em>Permission Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class permissionImpl extends MinimalEObjectImpl.Container implements permission {
	...
	protected EClass eStaticClass() {
		return Model4DataCtrackPackage.Literals.PERMISSION;
	}
		...
		if (base_Message != null && base_Message.eIsProxy()) {
			...
			if (base_Message != oldBase_Message) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.PERMISSION__BASE_MESSAGE, oldBase_Message, base_Message));
			}
		}
		return base_Message;
	}
	...
	public void setBase_Message(Message newBase_Message) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.PERMISSION__BASE_MESSAGE, oldBase_Message, base_Message));
	}
	...
	public EList<String> getPurpose() {
		if (purpose == null) {
			purpose = new EDataTypeUniqueEList<String>(String.class, this, Model4DataCtrackPackage.PERMISSION__PURPOSE);
		}
		return purpose;
	}
	...
	public void setPermissionType(ActionType newPermissionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.PERMISSION__PERMISSION_TYPE, oldPermissionType, permissionType));
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Model4DataCtrackValidator.PERMISSION__NO_ACCESS_PERMISSION_GIVEN_WITHOUT_USER_CONSENT,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4DataCtrackPackage.PERMISSION__BASE_MESSAGE:
				if (resolve) return getBase_Message();
				return basicGetBase_Message();
			case Model4DataCtrackPackage.PERMISSION__PURPOSE:
				return getPurpose();
			case Model4DataCtrackPackage.PERMISSION__PERMISSION_TYPE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Model4DataCtrackPackage.PERMISSION___NO_ACCESS_PERMISSION_GIVEN_WITHOUT_USER_CONSENT__DIAGNOSTICCHAIN_MAP:

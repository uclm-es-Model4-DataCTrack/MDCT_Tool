 ...
 * </p>
 * <ul>
 *   <li>{@link Model4DataCtrack.impl.StorageImpl#getNumberOfDrivers <em>Number Of Drivers</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.StorageImpl#getDirveCapacity <em>Dirve Capacity</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.StorageImpl#getReadBandwidth <em>Read Bandwidth</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.StorageImpl#getData <em>Data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StorageImpl extends HardwareImpl implements Storage {
	...
	protected EClass eStaticClass() {
		return Model4DataCtrackPackage.Literals.STORAGE;
	}
	...
	public void setNumberOfDrivers(int newNumberOfDrivers) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.STORAGE__NUMBER_OF_DRIVERS, oldNumberOfDrivers, numberOfDrivers));
	}
	...
	public NotificationChain basicSetDirveCapacity(Size newDirveCapacity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.STORAGE__DIRVE_CAPACITY, oldDirveCapacity, newDirveCapacity);
	...
	public void setDirveCapacity(Size newDirveCapacity) {
		if (newDirveCapacity != dirveCapacity) {
			...
			if (dirveCapacity != null)
				msgs = ((InternalEObject)dirveCapacity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Model4DataCtrackPackage.STORAGE__DIRVE_CAPACITY, null, msgs);
			if (newDirveCapacity != null)
				msgs = ((InternalEObject)newDirveCapacity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Model4DataCtrackPackage.STORAGE__DIRVE_CAPACITY, null, msgs);
			msgs = basicSetDirveCapacity(newDirveCapacity, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.STORAGE__DIRVE_CAPACITY, newDirveCapacity, newDirveCapacity));
	}
	...
	public NotificationChain basicSetReadBandwidth(Bandwidth newReadBandwidth, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.STORAGE__READ_BANDWIDTH, oldReadBandwidth, newReadBandwidth);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setReadBandwidth(Bandwidth newReadBandwidth) {
		if (newReadBandwidth != readBandwidth) {
			...
			if (readBandwidth != null)
				msgs = ((InternalEObject)readBandwidth).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Model4DataCtrackPackage.STORAGE__READ_BANDWIDTH, null, msgs);
			if (newReadBandwidth != null)
				msgs = ((InternalEObject)newReadBandwidth).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Model4DataCtrackPackage.STORAGE__READ_BANDWIDTH, null, msgs);
			msgs = basicSetReadBandwidth(newReadBandwidth, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.STORAGE__READ_BANDWIDTH, newReadBandwidth, newReadBandwidth));
	}
	...
	public EList<Data> getData() {
		if (data == null) {
			data = new EObjectResolvingEList<Data>(Data.class, this, Model4DataCtrackPackage.STORAGE__DATA);
		}
		return data;
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Model4DataCtrackValidator.STORAGE__NUMBER_OF_DRIVERS_GREATER_THAN_0,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Model4DataCtrackPackage.STORAGE__DIRVE_CAPACITY:
				return basicSetDirveCapacity(null, msgs);
			case Model4DataCtrackPackage.STORAGE__READ_BANDWIDTH:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4DataCtrackPackage.STORAGE__NUMBER_OF_DRIVERS:
				return getNumberOfDrivers();
			case Model4DataCtrackPackage.STORAGE__DIRVE_CAPACITY:
				return getDirveCapacity();
			case Model4DataCtrackPackage.STORAGE__READ_BANDWIDTH:
				return getReadBandwidth();
			case Model4DataCtrackPackage.STORAGE__DATA:
				return getData();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Model4DataCtrackPackage.STORAGE___NUMBER_OF_DRIVERS_GREATER_THAN_0__DIAGNOSTICCHAIN_MAP:

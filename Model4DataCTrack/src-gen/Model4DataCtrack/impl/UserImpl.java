 ...
 * </p>
 * <ul>
 *   <li>{@link Model4DataCtrack.impl.UserImpl#getInstances <em>Instances</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.UserImpl#getIdUser <em>Id User</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UserImpl extends PrincipalImpl implements User {
	...
	protected EClass eStaticClass() {
		return Model4DataCtrackPackage.Literals.USER;
	}
	...
	public void setInstances(int newInstances) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.USER__INSTANCES, oldInstances, instances));
	}
	...
	public void setIdUser(String newIdUser) {
		...
		idUser = newIdUser;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.USER__ID_USER, oldIdUser, idUser));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4DataCtrackPackage.USER__INSTANCES:
				return getInstances();
			case Model4DataCtrackPackage.USER__ID_USER:
				return getIdUser();
		}

 ...
 * </p>
 * <ul>
 *   <li>{@link Model4DataCtrack.impl.sendDataImpl#getBase_Message <em>Base Message</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.sendDataImpl#getMaxTime <em>Max Time</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.sendDataImpl#getData <em>Data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class sendDataImpl extends MinimalEObjectImpl.Container implements sendData {
	...
	protected EClass eStaticClass() {
		return Model4DataCtrackPackage.Literals.SEND_DATA;
	}
		...
		if (base_Message != null && base_Message.eIsProxy()) {
			...
			if (base_Message != oldBase_Message) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.SEND_DATA__BASE_MESSAGE, oldBase_Message, base_Message));
			}
		}
		return base_Message;
	}
	...
	public void setBase_Message(Message newBase_Message) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.SEND_DATA__BASE_MESSAGE, oldBase_Message, base_Message));
	}
	...
	public NotificationChain basicSetMaxTime(Time newMaxTime, NotificationChain msgs) {
		...
		maxTime = newMaxTime;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.SEND_DATA__MAX_TIME, oldMaxTime, newMaxTime);
	...
	public void setMaxTime(Time newMaxTime) {
		if (newMaxTime != maxTime) {
			...
			if (maxTime != null)
				msgs = ((InternalEObject)maxTime).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Model4DataCtrackPackage.SEND_DATA__MAX_TIME, null, msgs);
			if (newMaxTime != null)
				msgs = ((InternalEObject)newMaxTime).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Model4DataCtrackPackage.SEND_DATA__MAX_TIME, null, msgs);
			msgs = basicSetMaxTime(newMaxTime, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.SEND_DATA__MAX_TIME, newMaxTime, newMaxTime));
	}
	...
	public Data getData() {
		if (data != null && data.eIsProxy()) {
			...
			if (data != oldData) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.SEND_DATA__DATA, oldData, data));
			}
		}
		return data;
	}
	...
	public void setData(Data newData) {
		...
		data = newData;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.SEND_DATA__DATA, oldData, data));
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Model4DataCtrackValidator.SEND_DATA__SEND_DATA_TIMEUNIT_NOT_DAYS_OR_HOURS_OR_MINUTES,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Model4DataCtrackValidator.DIAGNOSTIC_SOURCE,
						 Model4DataCtrackValidator.SEND_DATA__SEND_DATA_MAX_TIME_VALUE_GREATER_THAN_0,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Model4DataCtrackPackage.SEND_DATA__MAX_TIME:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4DataCtrackPackage.SEND_DATA__BASE_MESSAGE:
				if (resolve) return getBase_Message();
				return basicGetBase_Message();
			case Model4DataCtrackPackage.SEND_DATA__MAX_TIME:
				return getMaxTime();
			case Model4DataCtrackPackage.SEND_DATA__DATA:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Model4DataCtrackPackage.SEND_DATA___SEND_DATA_TIMEUNIT_NOT_DAYS_OR_HOURS_OR_MINUTES__DIAGNOSTICCHAIN_MAP:
				return sendData_timeunit_not_days_or_hours_or_minutes((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Model4DataCtrackPackage.SEND_DATA___SEND_DATA_MAX_TIME_VALUE_GREATER_THAN_0__DIAGNOSTICCHAIN_MAP:

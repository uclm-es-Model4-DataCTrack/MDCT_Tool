 ...
 * </p>
 * <ul>
 *   <li>{@link Model4DataCtrack.impl.eraseDataImpl#getBase_Message <em>Base Message</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.eraseDataImpl#getData <em>Data</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.eraseDataImpl#getMachines <em>Machines</em>}</li>
 * </ul>
 *
 * @generated
 */
public class eraseDataImpl extends MinimalEObjectImpl.Container implements eraseData {
	...
	protected EClass eStaticClass() {
		return Model4DataCtrackPackage.Literals.ERASE_DATA;
	}
		...
		if (base_Message != null && base_Message.eIsProxy()) {
			...
			if (base_Message != oldBase_Message) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.ERASE_DATA__BASE_MESSAGE, oldBase_Message, base_Message));
			}
		}
		return base_Message;
	}
	...
	public void setBase_Message(Message newBase_Message) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.ERASE_DATA__BASE_MESSAGE, oldBase_Message, base_Message));
	}
	...
	public Data getData() {
		if (data != null && data.eIsProxy()) {
			...
			if (data != oldData) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.ERASE_DATA__DATA, oldData, data));
			}
		}
		return data;
	}
	...
	public void setData(Data newData) {
		...
		data = newData;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.ERASE_DATA__DATA, oldData, data));
	}
	...
	public EList<SSMProcessor> getMachines() {
		if (machines == null) {
			machines = new EObjectResolvingEList<SSMProcessor>(SSMProcessor.class, this, Model4DataCtrackPackage.ERASE_DATA__MACHINES);
		}
		return machines;
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Model4DataCtrackValidator.ERASE_DATA__MACHINE_CONTAINS_DATA_TO_ERASE,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Model4DataCtrackValidator.DIAGNOSTIC_SOURCE,
						 Model4DataCtrackValidator.ERASE_DATA__ERASE_DATA_DESTINATION_MACHINES_COMPLY_WITH_GDPR,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4DataCtrackPackage.ERASE_DATA__BASE_MESSAGE:
				if (resolve) return getBase_Message();
				return basicGetBase_Message();
			case Model4DataCtrackPackage.ERASE_DATA__DATA:
				if (resolve) return getData();
				return basicGetData();
			case Model4DataCtrackPackage.ERASE_DATA__MACHINES:
				return getMachines();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Model4DataCtrackPackage.ERASE_DATA___MACHINE_CONTAINS_DATA_TO_ERASE__DIAGNOSTICCHAIN_MAP:
				return machine_contains_data_to_erase((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Model4DataCtrackPackage.ERASE_DATA___ERASE_DATA_DESTINATION_MACHINES_COMPLY_WITH_GDPR__DIAGNOSTICCHAIN_MAP:

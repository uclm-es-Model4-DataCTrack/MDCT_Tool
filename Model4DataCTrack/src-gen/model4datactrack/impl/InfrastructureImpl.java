 ...
 * </p>
 * <ul>
 *   <li>{@link Model4DataCtrack.impl.InfrastructureImpl#getBase_Component <em>Base Component</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.InfrastructureImpl#getNetwork <em>Network</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.InfrastructureImpl#getCloudProvider <em>Cloud Provider</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.InfrastructureImpl#getDatacenterelements <em>Datacenterelements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InfrastructureImpl extends MinimalEObjectImpl.Container implements Infrastructure {
	...
	protected EClass eStaticClass() {
		return Model4DataCtrackPackage.Literals.INFRASTRUCTURE;
	}
		...
		if (base_Component != null && base_Component.eIsProxy()) {
			...
			if (base_Component != oldBase_Component) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.INFRASTRUCTURE__BASE_COMPONENT, oldBase_Component, base_Component));
			}
		}
	...
	public void setBase_Component(Component newBase_Component) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.INFRASTRUCTURE__BASE_COMPONENT, oldBase_Component, base_Component));
	}
	...
	public NotificationChain basicSetNetwork(Bandwidth newNetwork, NotificationChain msgs) {
		...
		network = newNetwork;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.INFRASTRUCTURE__NETWORK, oldNetwork, newNetwork);
	...
	public void setNetwork(Bandwidth newNetwork) {
		if (newNetwork != network) {
			...
			if (network != null)
				msgs = ((InternalEObject)network).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Model4DataCtrackPackage.INFRASTRUCTURE__NETWORK, null, msgs);
			if (newNetwork != null)
				msgs = ((InternalEObject)newNetwork).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Model4DataCtrackPackage.INFRASTRUCTURE__NETWORK, null, msgs);
			msgs = basicSetNetwork(newNetwork, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.INFRASTRUCTURE__NETWORK, newNetwork, newNetwork));
	}
	...
	public ControllerCP getCloudProvider() {
		if (cloudProvider != null && cloudProvider.eIsProxy()) {
			...
			if (cloudProvider != oldCloudProvider) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.INFRASTRUCTURE__CLOUD_PROVIDER, oldCloudProvider, cloudProvider));
			}
		}
	...
	public void setCloudProvider(ControllerCP newCloudProvider) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.INFRASTRUCTURE__CLOUD_PROVIDER, oldCloudProvider, cloudProvider));
	}
	...
	public EList<DataCenterElement> getDatacenterelements() {
		if (datacenterelements == null) {
			datacenterelements = new EObjectContainmentEList<DataCenterElement>(DataCenterElement.class, this, Model4DataCtrackPackage.INFRASTRUCTURE__DATACENTERELEMENTS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Model4DataCtrackPackage.INFRASTRUCTURE__NETWORK:
				return basicSetNetwork(null, msgs);
			case Model4DataCtrackPackage.INFRASTRUCTURE__DATACENTERELEMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4DataCtrackPackage.INFRASTRUCTURE__BASE_COMPONENT:
				if (resolve) return getBase_Component();
				return basicGetBase_Component();
			case Model4DataCtrackPackage.INFRASTRUCTURE__NETWORK:
				return getNetwork();
			case Model4DataCtrackPackage.INFRASTRUCTURE__CLOUD_PROVIDER:

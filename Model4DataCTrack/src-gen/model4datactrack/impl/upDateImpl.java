 ...
 * </p>
 * <ul>
 *   <li>{@link Model4DataCtrack.impl.upDateImpl#getBase_Message <em>Base Message</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.upDateImpl#getData <em>Data</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.upDateImpl#getMachines <em>Machines</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.upDateImpl#getNewSP <em>New SP</em>}</li>
 * </ul>
 *
 * @generated
 */
public class upDateImpl extends MinimalEObjectImpl.Container implements upDate {
	...
	protected EClass eStaticClass() {
		return Model4DataCtrackPackage.Literals.UP_DATE;
	}
		...
		if (base_Message != null && base_Message.eIsProxy()) {
			...
			if (base_Message != oldBase_Message) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.UP_DATE__BASE_MESSAGE, oldBase_Message, base_Message));
			}
		}
		return base_Message;
	}
	...
	public void setBase_Message(Message newBase_Message) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.UP_DATE__BASE_MESSAGE, oldBase_Message, base_Message));
	}
	...
	public Data getData() {
		if (data != null && data.eIsProxy()) {
			...
			if (data != oldData) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.UP_DATE__DATA, oldData, data));
			}
		}
		return data;
	}
	...
	public void setData(Data newData) {
		...
		data = newData;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.UP_DATE__DATA, oldData, data));
	}
	...
	public EList<SSMProcessor> getMachines() {
		if (machines == null) {
			machines = new EObjectResolvingEList<SSMProcessor>(SSMProcessor.class, this, Model4DataCtrackPackage.UP_DATE__MACHINES);
		}
		return machines;
	}
	...
	public StickyPolicy getNewSP() {
		if (newSP != null && newSP.eIsProxy()) {
			...
			if (newSP != oldNewSP) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.UP_DATE__NEW_SP, oldNewSP, newSP));
			}
		}
		return newSP;
	}
	...
	public void setNewSP(StickyPolicy newNewSP) {
		...
		newSP = newNewSP;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.UP_DATE__NEW_SP, oldNewSP, newSP));
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Model4DataCtrackValidator.UP_DATE__MACHINE_CONTAINS_DATA_TO_UPDATE,
			...
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 Model4DataCtrackValidator.DIAGNOSTIC_SOURCE,
						 Model4DataCtrackValidator.UP_DATE__UP_DATE_DESTINATION_MACHINES_COMPLY_WITH_GDPR,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4DataCtrackPackage.UP_DATE__BASE_MESSAGE:
				if (resolve) return getBase_Message();
				return basicGetBase_Message();
			case Model4DataCtrackPackage.UP_DATE__DATA:
				if (resolve) return getData();
				return basicGetData();
			case Model4DataCtrackPackage.UP_DATE__MACHINES:
				return getMachines();
			case Model4DataCtrackPackage.UP_DATE__NEW_SP:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Model4DataCtrackPackage.UP_DATE___MACHINE_CONTAINS_DATA_TO_UPDATE__DIAGNOSTICCHAIN_MAP:
				return machine_contains_data_to_update((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
			case Model4DataCtrackPackage.UP_DATE___UP_DATE_DESTINATION_MACHINES_COMPLY_WITH_GDPR__DIAGNOSTICCHAIN_MAP:

 ...
 * </p>
 * <ul>
 *   <li>{@link Model4DataCtrack.impl.DataFieldImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataFieldImpl extends MinimalEObjectImpl.Container implements DataField {
	...
	protected EClass eStaticClass() {
		return Model4DataCtrackPackage.Literals.DATA_FIELD;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.DATA_FIELD__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4DataCtrackPackage.DATA_FIELD__VALUE:
				return getValue();
		}

 ...
 * </p>
 * <ul>
 *   <li>{@link Model4DataCtrack.impl.tpImpl#getBase_Message <em>Base Message</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.tpImpl#getTp <em>Tp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class tpImpl extends MinimalEObjectImpl.Container implements tp {
	...
	protected EClass eStaticClass() {
		return Model4DataCtrackPackage.Literals.TP;
	}
		...
		if (base_Message != null && base_Message.eIsProxy()) {
			...
			if (base_Message != oldBase_Message) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.TP__BASE_MESSAGE, oldBase_Message, base_Message));
			}
		}
		return base_Message;
	}
	...
	public void setBase_Message(Message newBase_Message) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.TP__BASE_MESSAGE, oldBase_Message, base_Message));
	}
	...
	public StatelessAppCTP getTp() {
		if (tp != null && tp.eIsProxy()) {
			...
			if (tp != oldTp) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.TP__TP, oldTp, tp));
			}
		}
		return tp;
	}
	...
	public void setTp(StatelessAppCTP newTp) {
		...
		tp = newTp;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.TP__TP, oldTp, tp));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4DataCtrackPackage.TP__BASE_MESSAGE:
				if (resolve) return getBase_Message();
				return basicGetBase_Message();
			case Model4DataCtrackPackage.TP__TP:

 ...
 * </p>
 * <ul>
 *   <li>{@link Model4DataCtrack.impl.newRestrictionsImpl#getBase_Message <em>Base Message</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.newRestrictionsImpl#getData <em>Data</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.newRestrictionsImpl#getNewSP <em>New SP</em>}</li>
 * </ul>
 *
 * @generated
 */
public class newRestrictionsImpl extends MinimalEObjectImpl.Container implements newRestrictions {
	...
	protected EClass eStaticClass() {
		return Model4DataCtrackPackage.Literals.NEW_RESTRICTIONS;
	}
		...
		if (base_Message != null && base_Message.eIsProxy()) {
			...
			if (base_Message != oldBase_Message) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.NEW_RESTRICTIONS__BASE_MESSAGE, oldBase_Message, base_Message));
			}
		}
		return base_Message;
	}
	...
	public void setBase_Message(Message newBase_Message) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.NEW_RESTRICTIONS__BASE_MESSAGE, oldBase_Message, base_Message));
	}
	...
	public Data getData() {
		if (data != null && data.eIsProxy()) {
			...
			if (data != oldData) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.NEW_RESTRICTIONS__DATA, oldData, data));
			}
		}
		return data;
	}
	...
	public void setData(Data newData) {
		...
		data = newData;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.NEW_RESTRICTIONS__DATA, oldData, data));
	}
	...
	public StickyPolicy getNewSP() {
		if (newSP != null && newSP.eIsProxy()) {
			...
			if (newSP != oldNewSP) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.NEW_RESTRICTIONS__NEW_SP, oldNewSP, newSP));
			}
		}
		return newSP;
	}
	...
	public void setNewSP(StickyPolicy newNewSP) {
		...
		newSP = newNewSP;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.NEW_RESTRICTIONS__NEW_SP, oldNewSP, newSP));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4DataCtrackPackage.NEW_RESTRICTIONS__BASE_MESSAGE:
				if (resolve) return getBase_Message();
				return basicGetBase_Message();
			case Model4DataCtrackPackage.NEW_RESTRICTIONS__DATA:
				if (resolve) return getData();
				return basicGetData();
			case Model4DataCtrackPackage.NEW_RESTRICTIONS__NEW_SP:

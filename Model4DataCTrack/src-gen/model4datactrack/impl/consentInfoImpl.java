 ...
 * </p>
 * <ul>
 *   <li>{@link Model4DataCtrack.impl.consentInfoImpl#getBase_Message <em>Base Message</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.consentInfoImpl#getPurpose <em>Purpose</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.consentInfoImpl#getAction <em>Action</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.consentInfoImpl#getTp <em>Tp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class consentInfoImpl extends MinimalEObjectImpl.Container implements consentInfo {
	...
	protected EClass eStaticClass() {
		return Model4DataCtrackPackage.Literals.CONSENT_INFO;
	}
		...
		if (base_Message != null && base_Message.eIsProxy()) {
			...
			if (base_Message != oldBase_Message) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.CONSENT_INFO__BASE_MESSAGE, oldBase_Message, base_Message));
			}
		}
		return base_Message;
	}
	...
	public void setBase_Message(Message newBase_Message) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.CONSENT_INFO__BASE_MESSAGE, oldBase_Message, base_Message));
	}
	...
	public EList<String> getPurpose() {
		if (purpose == null) {
			purpose = new EDataTypeUniqueEList<String>(String.class, this, Model4DataCtrackPackage.CONSENT_INFO__PURPOSE);
		}
		return purpose;
	}
	...
	public void setAction(ActionType newAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.CONSENT_INFO__ACTION, oldAction, action));
	}
	...
	public StatelessAppCTP getTp() {
		if (tp != null && tp.eIsProxy()) {
			...
			if (tp != oldTp) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.CONSENT_INFO__TP, oldTp, tp));
			}
		}
		return tp;
	}
	...
	public void setTp(StatelessAppCTP newTp) {
		...
		tp = newTp;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.CONSENT_INFO__TP, oldTp, tp));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4DataCtrackPackage.CONSENT_INFO__BASE_MESSAGE:
				if (resolve) return getBase_Message();
				return basicGetBase_Message();
			case Model4DataCtrackPackage.CONSENT_INFO__PURPOSE:
				return getPurpose();
			case Model4DataCtrackPackage.CONSENT_INFO__ACTION:
				return getAction();
			case Model4DataCtrackPackage.CONSENT_INFO__TP:

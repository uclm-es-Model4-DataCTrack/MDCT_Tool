 ...
 * </p>
 * <ul>
 *   <li>{@link Model4DataCtrack.impl.rectifyDataImpl#getBase_Message <em>Base Message</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.rectifyDataImpl#getData <em>Data</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.rectifyDataImpl#getNewData <em>New Data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class rectifyDataImpl extends MinimalEObjectImpl.Container implements rectifyData {
	...
	protected EClass eStaticClass() {
		return Model4DataCtrackPackage.Literals.RECTIFY_DATA;
	}
		...
		if (base_Message != null && base_Message.eIsProxy()) {
			...
			if (base_Message != oldBase_Message) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.RECTIFY_DATA__BASE_MESSAGE, oldBase_Message, base_Message));
			}
		}
		return base_Message;
	}
	...
	public void setBase_Message(Message newBase_Message) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.RECTIFY_DATA__BASE_MESSAGE, oldBase_Message, base_Message));
	}
	...
	public Data getData() {
		if (data != null && data.eIsProxy()) {
			...
			if (data != oldData) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Model4DataCtrackPackage.RECTIFY_DATA__DATA, oldData, data));
			}
		}
		return data;
	}
	...
	public void setData(Data newData) {
		...
		data = newData;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.RECTIFY_DATA__DATA, oldData, data));
	}
	...
	public EList<DataField> getNewData() {
		if (newData == null) {
			newData = new EObjectContainmentEList<DataField>(DataField.class, this, Model4DataCtrackPackage.RECTIFY_DATA__NEW_DATA);
		}
		return newData;
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 Model4DataCtrackValidator.RECTIFY_DATA__NO_EMPTY_RECTIFY_FIELDS,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Model4DataCtrackPackage.RECTIFY_DATA__NEW_DATA:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4DataCtrackPackage.RECTIFY_DATA__BASE_MESSAGE:
				if (resolve) return getBase_Message();
				return basicGetBase_Message();
			case Model4DataCtrackPackage.RECTIFY_DATA__DATA:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case Model4DataCtrackPackage.RECTIFY_DATA___NO_EMPTY_RECTIFY_FIELDS__DIAGNOSTICCHAIN_MAP:

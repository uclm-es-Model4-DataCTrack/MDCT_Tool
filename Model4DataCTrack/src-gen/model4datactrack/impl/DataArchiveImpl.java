 ...
 * </p>
 * <ul>
 *   <li>{@link Model4DataCtrack.impl.DataArchiveImpl#getContents <em>Contents</em>}</li>
 *   <li>{@link Model4DataCtrack.impl.DataArchiveImpl#getIdData <em>Id Data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataArchiveImpl extends MinimalEObjectImpl.Container implements DataArchive {
	...
	protected EClass eStaticClass() {
		return Model4DataCtrackPackage.Literals.DATA_ARCHIVE;
	}
	...
	public EList<DataField> getContents() {
		if (contents == null) {
			contents = new EObjectContainmentEList<DataField>(DataField.class, this, Model4DataCtrackPackage.DATA_ARCHIVE__CONTENTS);
		}
		return contents;
	}
	...
	public void setIdData(String newIdData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Model4DataCtrackPackage.DATA_ARCHIVE__ID_DATA, oldIdData, idData));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Model4DataCtrackPackage.DATA_ARCHIVE__CONTENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model4DataCtrackPackage.DATA_ARCHIVE__CONTENTS:
				return getContents();
			case Model4DataCtrackPackage.DATA_ARCHIVE__ID_DATA:
				return getIdData();
		}
